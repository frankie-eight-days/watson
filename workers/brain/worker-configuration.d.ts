/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: baf8815ef7e90304c5549034b771ee50)
// Runtime types generated with workerd@1.20260708.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	CONVEX_URL: "https://friendly-sheep-865.convex.cloud";
	CONVEX_SITE_URL: "https://friendly-sheep-865.convex.site";
	MODEL_TERRA: "gpt-5.6-terra";
	MODEL_LUNA: "gpt-5.6-luna";
	WATSON_EMIT_MODE: "convex";
	SANDBOX_RUNNER_URL: "https://watson-sandbox-runner.frankkevinwalsh.workers.dev";
	HERMES: DurableObjectNamespace<import("./src/index").HermesAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HermesAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONVEX_URL" | "CONVEX_SITE_URL" | "MODEL_TERRA" | "MODEL_LUNA" | "WATSON_EMIT_MODE" | "SANDBOX_RUNNER_URL">> {}
}
